...
out = pd.read_csv("mro/spiders/csv_data/Regal/Regal_Beloit_images.csv", sep=',')
...
f = open('mro/spiders/csv_data/additions/viewstage.txt', 'r')
viewstage = f.read()
f.close()


class RegalptsImgCrawl(scrapy.Spider):
    name = "regalpts_img"

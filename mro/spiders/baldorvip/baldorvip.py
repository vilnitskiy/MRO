...
out = pd.read_csv("mro/spiders/csv_data/Baldor/baldor.csv", sep=',')
...
class Baldor(scrapy.Spider):
    ...
    def parse_item(self, response):
        ...
        return FormRequest(url="https://www.baldorvip.com/Product/LoadSpecsTab",
                           ...
                           meta={'row': response.meta['row'], 'res': result, 'data2': data2, 'data1': data1})
    ...
    def parse_item1(self, response):
        ...
        return FormRequest(url="https://www.baldorvip.com/Product/LoadPerformanceTab",
                           ...
                           meta={'row': response.meta['row'], 'res': result, 'data2': response.meta['data2'],
                                 'data1': response.meta['data1']})

    def parse_item2(self, response):
        result = str(response.meta['res']) + str(
            response.xpath('//*[@id="PerfDataList"]/option/text()').extract_first())
